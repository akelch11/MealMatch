...
def validate_ondemand_times(t1):
    ...
    if (t1 == None):
        ...
        time_lunch = datetime.fromisoformat(
            date.today().isoformat() + ' ' + lunch_start + ":00")
        time_lunch_end = datetime.fromisoformat(
            date.today().isoformat() + ' 14:00:00')

        time_dinner = datetime.fromisoformat(
            date.today().isoformat() + ' 17:00:00')
        time_dinner_end = datetime.fromisoformat(
            date.today().isoformat() + ' 20:00:00')
